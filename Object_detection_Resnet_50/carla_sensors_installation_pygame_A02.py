...
traffic_blueprints = blueprint_library.filter("vehicle.*")
...
print("Traffic vehicles:",len(traffic_vehicles))
...
print("RGB camera attached to the edo vehicle")
...
## Depth logarithmic grayscale

def process_depth_log(image):
    ...
    depth_log = (
        depth_log / np.max(depth_log) * 255
    ).astype(np.uint8)
